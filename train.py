...
def parse_args():
    ...
    parser.add_argument(
        '--fs_setting', default='Pretrain_SPLIT1')
    parser.add_argument(
        '--pretrain_weights', default=None)    
    parser.add_argument(
...
def main():
    ...
    cfg = SetDefectDataset(cfg,
                        defect_data=args.defect,
                        setting=args.fs_setting,
                        pretrain_weights=args.pretrain_weights)
    save_name = f"{config_name[:-3]}-{args.defect}-{args.fs_setting}.py"
